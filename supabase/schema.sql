...
insert into conferences (id, name, city, venue_name, venue_lat, venue_lng, nights, topic_tags) values
  ...
  ('lts-tysons-2026', 'CIX Summit 2026', 'McLean, VA', '1765 Greensboro Station Pl, 7th Floor', 38.9221, -77.2332, ARRAY['2026-07-30']::text[], ARRAY['AI','FinTech','DevTools','Design','Climate']::text[]);
